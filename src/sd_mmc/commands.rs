...
pub const SDMMC_SPI_CMD0_GO_IDLE_STATE: Command<CmdR1R6, NoFlag, SpiMode, SdMmcDevice> =
    Command { number: 0, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
pub const SDMMC_MCI_CMD0_GO_IDLE_STATE: Command<NoResponse, OpenDrain, MciMode, SdMmcDevice> =
    Command { number: 0, response: NoResponse, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_SPI_CMD1_SEND_OP_COND: Command<CmdR1R6, NoFlag, SpiMode, MmcDevice> =
    Command { number: 1, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
pub const MMC_MCI_CMD1_SEND_OP_COND: Command<CmdR3R4, OpenDrain, MciMode, MmcDevice> =
    Command { number: 1, response: CmdR3R4, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD2_ALL_SEND_CID: Command<CmdR2, OpenDrain, DontCareMode, SdMmcDevice> =
    Command { number: 2, response: CmdR2, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };
...
pub const SD_CMD3_SEND_RELATIVE_ADDR: Command<CmdR1R6, OpenDrain, DontCareMode, SdDevice> =
    Command { number: 3, response: CmdR1R6, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD3_SET_RELATIVE_ADDR: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 3, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD4_SET_DSR: Command<NoResponse, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 4, response: NoResponse, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD5_SLEEP_AWAKE: Command<CmdR1B, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 5, response: CmdR1B, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD7_SELECT_CARD_CMD: Command<CmdR1B, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 7, response: CmdR1B, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
pub const SDMMC_CMD7_DESELECT_CARD_CMD: Command<CmdR1R6, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 7, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD8_SEND_EXT_CSD: Command<CmdR1R6, SingleBlock, DontCareMode, MmcDevice> =
    Command { number: 7, response: CmdR1R6, flag: SingleBlock, _mode: PhantomData, _device: PhantomData };
...
pub const SD_CMD8_SEND_IF_COND: Command<CmdR7, OpenDrain, DontCareMode, SdDevice> =
    Command { number: 8, response: CmdR7, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_SPI_CMD9_SEND_CSD: Command<CmdR1R6, SingleBlock, SpiMode, SdMmcDevice> =
    Command { number: 9, response: CmdR1R6, flag: SingleBlock, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_MCI_CMD9_SEND_CSD: Command<CmdR2, NoFlag, MciMode, SdMmcDevice> =
    Command { number: 9, response: CmdR2, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD10_SEND_CID: Command<CmdR2, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 10, response: CmdR2, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD11_READ_DAT_UNTIL_STOP: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 11, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD12_STOP_TRANSMISSION: Command<CmdR1B, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 12, response: CmdR1B, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_SPI_CMD13_SEND_STATUS: Command<CmdR2, NoFlag, SpiMode, SdMmcDevice> =
    Command { number: 13, response: CmdR2, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_MCI_CMD13_SEND_STATUS: Command<CmdR1R6, NoFlag, MciMode, SdMmcDevice> =
    Command { number: 13, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD14_BUSTEST_R: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 14, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD15_GO_INACTIVE_STATE: Command<NoResponse, OpenDrain, DontCareMode, SdMmcDevice> =
    Command { number: 15, response: NoResponse, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD19_BUSTEST_W: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 19, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// Cmd58(R3): Reads the OCR register of a card
pub const SDMMC_SPI_CMD58_READ_OCR: Command<CmdR3R4, NoFlag, SpiMode, SdMmcDevice> =
    Command { number: 19, response: CmdR3R4, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// Cmd59(R1): Turns the CRC option on or off
pub const SDMMC_SPI_CMD59_CRC_ON_OFF: Command<CmdR1R6, NoFlag, SpiMode, SdMmcDevice> =
    Command { number: 59, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD16_SET_BLOCKLEN: Command<CmdR1R6, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 16, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD17_READ_SINGLE_BLOCK: Command<CmdR1R6, SingleBlock, DontCareMode, SdMmcDevice> =
    Command { number: 17, response: CmdR1R6, flag: SingleBlock, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD18_READ_MULTIPLE_BLOCK: Command<CmdR1R6, MultiBlock, DontCareMode, SdMmcDevice> =
    Command { number: 18, response: CmdR1R6, flag: MultiBlock, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD20_WRITE_DAT_UNTIL_STOP: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 20, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD23_SET_BLOCK_COUNT: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 23, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// Cmd24(adtc, R1): Write block
pub const SDMMC_CMD24_WRITE_BLOCK: Command<CmdR1R6, WriteSingleBlock, DontCareMode, SdMmcDevice> =
    Command { number: 24, response: CmdR1R6, flag: WriteSingleBlock, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD25_WRITE_MULTIPLE_BLOCK: Command<CmdR1R6, WriteMultiBlock, DontCareMode, SdMmcDevice> =
    Command { number: 25, response: CmdR1R6, flag: WriteMultiBlock, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD26_PROGRAM_CID: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 26, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD27_PROGRAM_CSD: Command<CmdR1R6, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 27, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SD_CMD32_ERASE_WR_BLK_START: Command<CmdR1R6, NoFlag, DontCareMode, SdDevice> =
    Command { number: 32, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// SD Cmd33(ac, R1):
pub const SD_CMD33_ERASE_WR_BLK_END: Command<CmdR1R6, NoFlag, DontCareMode, SdDevice> =
    Command { number: 33, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// MMC Cmd35(ac, R1):
pub const MMC_CMD35_ERASE_GROUP_START: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 35, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// MMC Cmd36(ac, R1):
pub const MMC_CMD36_ERASE_GROUP_END: Command<CmdR1R6, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 36, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// Cmd38(ac, R1B):
pub const SDMMC_CMD38_ERASE: Command<CmdR1B, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 38, response: CmdR1B, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD28_SET_WRITE_PROT: Command<CmdR1B, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 28, response: CmdR1B, flag: NoFlag, _mode: PhantomData, _device: PhantomData };

// Cmd29(ac, R1b): Clr write protection
pub const SDMMC_CMD29_CLR_WRITE_PROT: Command<CmdR1B, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 29, response: CmdR1B, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD30_SEND_WRITE_PROT: Command<CmdR1R6, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 30, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD42_LOCK_UNLOCK: Command<CmdR1R6, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 42, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD55_APP_CMD: Command<CmdR1R6, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 55, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDMMC_CMD56_GEN_CMD: Command<CmdR1R6, NoFlag, DontCareMode, SdMmcDevice> =
    Command { number: 56, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD6_SWITCH: Command<CmdR1B, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 6, response: CmdR1B, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SD_CMD6_SWITCH_FUNC: Command<CmdR1R6, SingleBlock, DontCareMode, SdDevice> =
    Command { number: 6, response: CmdR1R6, flag: SingleBlock, _mode: PhantomData, _device: PhantomData };

// ACMD6(ac, R1): Define the data bus width
pub const SD_ACMD6_SET_BUS_WIDTH: Command<CmdR1R6, NoFlag, DontCareMode, SdDevice> =
    Command { number: 6, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SD_ACMD22_SEND_NUM_WR_BLOCKS: Command<CmdR1R6, NoFlag, DontCareMode, SdDevice> =
    Command { number: 22, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SD_MCI_ACMD41_SD_SEND_OP_COND: Command<CmdR3R4, OpenDrain, MciMode, SdDevice> =
    Command { number: 41, response: CmdR3R4, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };
...
pub const SD_SPI_ACMD41_SD_SEND_OP_COND: Command<CmdR1R6, NoFlag, SpiMode, SdDevice> =
    Command { number: 41, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SD_ACMD51_SEND_SCR: Command<CmdR1R6, NoFlag, DontCareMode, SdDevice> =
    Command { number: 51, response: CmdR1R6, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD39_FAST_IO: Command<CmdR3R4, NoFlag, DontCareMode, MmcDevice> =
    Command { number: 39, response: CmdR3R4, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const MMC_CMD40_GO_IRQ_STATE: Command<CmdR5, OpenDrain, DontCareMode, MmcDevice> =
    Command { number: 40, response: CmdR5, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };

// SDIO Cmd5(R4): Send operation condition
pub const SDIO_CMD5_SEND_OP_COND: Command<CmdR3R4, OpenDrain, DontCareMode, SdioDevice> =
    Command { number: 5, response: CmdR3R4, flag: OpenDrain, _mode: PhantomData, _device: PhantomData };

// SDIO CMD52(R5): Direct IO read/write
pub const SDIO_CMD52_IO_RW_DIRECT: Command<CmdR5, NoFlag, DontCareMode, SdioDevice> =
    Command { number: 52, response: CmdR5, flag: NoFlag, _mode: PhantomData, _device: PhantomData };
...
pub const SDIO_CMD53_IO_R_BYTE_EXTENDED: Command<CmdR5, SdioByte, DontCareMode, SdioDevice> =
    Command { number: 53, response: CmdR5, flag: SdioByte, _mode: PhantomData, _device: PhantomData };
pub const SDIO_CMD53_IO_W_BYTE_EXTENDED: Command<CmdR5, SdioWriteByte, DontCareMode, SdioDevice> =
    Command { number: 53, response: CmdR5, flag: SdioWriteByte, _mode: PhantomData, _device: PhantomData };
pub const SDIO_CMD53_IO_R_BLOCK_EXTENDED: Command<CmdR5, SdioBlock, DontCareMode, SdioDevice> =
    Command { number: 53, response: CmdR5, flag: SdioBlock, _mode: PhantomData, _device: PhantomData };
pub const SDIO_CMD53_IO_W_BLOCK_EXTENDED: Command<CmdR5, SdioWriteBlock, DontCareMode, SdioDevice> =
    Command { number: 53, response: CmdR5, flag: SdioWriteBlock, _mode: PhantomData, _device: PhantomData };