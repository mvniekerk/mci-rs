...
impl CardType {
    pub fn set_unknown(&mut self) -> &Self {
        self.val = 0x0;
        self
    }

    pub fn set_sd(&mut self, sd: bool) -> &Self {
    ...
    pub fn set_mmc(&mut self, mmc: bool) -> &Self {
    ...
    pub fn set_sdio(&mut self, sdio: bool) -> &Self {
    ...
    pub fn set_high_capacity(&mut self, hc: bool) -> &Self {
